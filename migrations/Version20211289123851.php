...
final class Version20211289123851 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $order->addColumn('total_sum', 'decimal', ['precision' => 12, 'scale' => 2, 'notnull' => true, 'default' => 0.00]);
        $order->addColumn('discount_promo', 'decimal', ['precision' => 12, 'scale' => 2, 'notnull' => true, 'default' => 0.00]);
        $order->addColumn('order_sum', 'decimal', ['precision' => 12, 'scale' => 2, 'notnull' => true, 'default' => 0.00]);

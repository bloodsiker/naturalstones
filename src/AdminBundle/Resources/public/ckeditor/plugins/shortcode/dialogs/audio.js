...
(function () {
    ...
    CKEDITOR.dialog.add('audio', function (editor) {
        return {
            title: editor.lang.shortcode.audio.dialog_title,
            minWidth: 400,
            minHeight: 95,
            contents: [
                {
                    id: 'basic-tab',
                    label: editor.lang.shortcode.audio.tab_basic_label,
                    elements: [
                        {
                            type: 'hbox',
                            widths: ['90%', '10%'],
                            children: [
                                ...
                                },
                                {
                                    id: 'audio_select',
                                    type: 'button',
                                    label: editor.lang.shortcode.audio.select_label,
                                    title: editor.lang.shortcode.audio.select_title,
                                    style: 'margin-top: 17px;',
                                    hidden: true,
                                    filebrowser: {
                                        action: 'Browse',
                                        url: editor.config.filebrowserAudioListUrl,
                                        target: 'basic-tab:id',

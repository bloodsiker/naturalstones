...
CKEDITOR.dialog.add("symbol", function (j) {
        ...
        if (null != a) {
            for (var s = CKEDITOR.tools.getNextId() + "_symbol_table_label", i = [""], h = 0, d = 0, j = !1, f, g, k = a.split(","), l = 0; l < k.length; l++) {
                ...
                if (a >= f) {
                    ...
                    for (; f <= a;) {
                        0 == d && i.push("<tr>");
                        for (var e = !0, n = d; n < c; n++, f++) if (f <= a) {
                            var o = t(f), p = q && q[f] || o,
                                r = "cke_symbol_label_" + f + "_" + CKEDITOR.tools.getNextNumber();
    ...
    var m = "&nbsp;", n = null, d, q = j.lang.symbol, k = null, p = function (a) {
        ...
        l, g = function (a, b) {
            ...
            if ("a" == b.getName() && (c = b.getChild(0).getHtml())) {
                ...
                var i = 0,
                    i = "&nbsp;" == c ? 160 : c.length > m.length && 0 == c.indexOf(m) ? c.charCodeAt(m.length) : c.charCodeAt(0);
        ...
        h = function (a, b) {
            ...
            switch (c) {
                case 38:
                    if (c = b.getParent().getParent().getPrevious()) c =
                ...
                case d ? 37 : 39:
                case 9:
                    if (c = b.getParent().getNext()) c = c.getChild(0), 1 == c.type ? (c.focus(), h(null, b), g(null, c), a.preventDefault(!0)) : h(null, b); else if (c = b.getParent().getParent().getNext()) (c = c.getChild([0,
                        0])) && 1 == c.type ? (c.focus(), h(null, b), g(null, c), a.preventDefault(!0)) : h(null, b);
                    break;
                case d ? 39 : 37:
        ...
        }), x = [CKEDITOR.dialog.cancelButton], y = j.lang.common.generalTab, z = j.lang.common.generalTab;
    j.config.sortSymbolRangesAlphabetically ? k || (k = CKEDITOR.config.symbolRanges.slice(),
        k.sort(w)) : k = CKEDITOR.config.symbolRanges;
    return {
        title: "Select Symbol", buttons: x, charColumns: 16, onShow: function () {
            ...
            id: "info", label: y, title: z, padding: 0, align: "top", onHide: function () {
                d && d.destroy()
            }, elements: [{
                type: "vbox", align: "top", width: "100%", children: [{
                    type: "select", id: "symbolRange", width: "100%", items: k, size: 1, onChange: function (a) {
                    ...
                    type: "hbox", align: "top", width: "100%",
                    children: [{type: "html", html: "<div></div>"}, {
                        type: "html",
                        id: "unicodePreview",
                        className: "cke_dark_background",
                        style: "border:1px solid #eeeeee;font-size:14px;height:20px;width:192px;padding-top:25px;font-family:'Microsoft Sans Serif',Arial,'Arial Unicode',Helvetica,Verdana;text-align:center;",
                        html: "<div>&nbsp;</div>"
                    }, {
                        type: "html",
                        id: "charPreview",

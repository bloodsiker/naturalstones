...
{
    public const MIME_TYPE_IF_UNKNOWN = 'application/octet-stream';
    ...
    public static function getMimeType(string|\SplFileInfo $file): string
    {
        if (is_string($file)) {
        ...
        if (function_exists('finfo_open') && $file->isFile()) {
            ...
            $mimeType = finfo_file($fileInfo, $file->getPath());
    ...
    public static function getFontAwesomeIcon(string $file, bool $fixedWidth = false): string
    {
        $fileMimeType = self::getMimeType($file);
        $foundIcon = 'fa-file-o';
        ...
        return 'fa ' . $foundIcon . ($fixedWidth ? ' fa-fw' : '');
    }
}
...
#[ORM\Entity(repositoryClass: \ShareBundle\Entity\ZodiacRepository::class)]
#[ORM\HasLifecycleCallbacks]
class Zodiac implements TranslatableInterface
{
     ...
     * @var ArrayCollection
     */
    #[ORM\ManyToMany(targetEntity: \ShareBundle\Entity\Stone::class, mappedBy: 'zodiacs')]
    protected $stones;
